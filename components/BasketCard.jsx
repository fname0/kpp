...
function BasketCard(props) {
    ...
    return (
        <div className={props.deleted === "0" ? props.out === "False" ? "basketCard" : "basketCardDel" : "basketCardDel"}>
            ...
            {props.deleted === "0" ? props.out === "False" ? <div className="basketCountInputCont"><input type="number" className="basketCountInput" max={1000} value={count} onChange={(event) => {setCount(event.target.value); countChange(event.target.value)}}/></div> :
