...
function BasketCard(props) {
    ...
    return (
        <div className={props.deleted === "0" ? props.out === "False" ? "basketCard" : "basketCardDel" : "basketCardDel"}>
            ...
            {props.deleted === "0" ? props.out === "False" ? <div className="basketCountInputCont"><input type="number" className="basketCountInput" maxLength={3} minLength={1} value={count} onChange={(event) => {if (event.target.value > 0) {setCount(event.target.value); countChange(event.target.value)}}}/></div> :
